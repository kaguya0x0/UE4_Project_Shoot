...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USoundSubmix_SetSubmixOutputVolume_Statics::Function_MetaDataParams[] = {
		{ "Category", "Audio" },
		{ "Comment", "/** Sets the output volume of the submix. This dynamic volume acts as a multiplier on the OutputVolume property of this submix.  */" },
		{ "ModuleRelativePath", "Classes/Sound/SoundSubmix.h" },
		{ "ToolTip", "Sets the output volume of the submix. This dynamic volume acts as a multiplier on the OutputVolume property of this submix." },
		{ "WorldContext", "WorldContextObject" },
	};
#endif
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_OutputVolumeModulation_MetaData[];
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_OutputVolumeModulation;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_WetLevelModulation_MetaData[];
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_WetLevelModulation;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_DryLevelModulation_MetaData[];
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_DryLevelModulation;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USoundSubmix_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_USoundSubmix_SetSubmixOutputVolume, "SetSubmixOutputVolume" }, // 3494099384
...
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USoundSubmix_Statics::NewProp_OutputVolumeModulation_MetaData[] = {
		{ "AudioParam", "Volume" },
		{ "Category", "Modulation" },
		{ "Comment", "/** Modulation to apply to the submix Output Volume (in dB)*/" },
		{ "DisplayName", "Output Volume Modulation" },
		{ "ModuleRelativePath", "Classes/Sound/SoundSubmix.h" },
		{ "ToolTip", "Modulation to apply to the submix Output Volume (in dB)" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_USoundSubmix_Statics::NewProp_OutputVolumeModulation = { "OutputVolumeModulation", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USoundSubmix, OutputVolumeModulation), Z_Construct_UScriptStruct_FSoundModulationDestinationSettings, METADATA_PARAMS(Z_Construct_UClass_USoundSubmix_Statics::NewProp_OutputVolumeModulation_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USoundSubmix_Statics::NewProp_OutputVolumeModulation_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USoundSubmix_Statics::NewProp_WetLevelModulation_MetaData[] = {
		{ "AudioParam", "Volume" },
		{ "Category", "Modulation" },
		{ "Comment", "/** Modulation to apply to the submix Wet Level (in dB)*/" },
		{ "DisplayName", "Wet Level Modulation" },
		{ "ModuleRelativePath", "Classes/Sound/SoundSubmix.h" },
		{ "ToolTip", "Modulation to apply to the submix Wet Level (in dB)" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_USoundSubmix_Statics::NewProp_WetLevelModulation = { "WetLevelModulation", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USoundSubmix, WetLevelModulation), Z_Construct_UScriptStruct_FSoundModulationDestinationSettings, METADATA_PARAMS(Z_Construct_UClass_USoundSubmix_Statics::NewProp_WetLevelModulation_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USoundSubmix_Statics::NewProp_WetLevelModulation_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USoundSubmix_Statics::NewProp_DryLevelModulation_MetaData[] = {
		{ "AudioParam", "Volume" },
		{ "Category", "Modulation" },
		{ "Comment", "/** Modulation to apply to the submix Dry Level (in dB)*/" },
		{ "DisplayName", "Dry Level Modulation" },
		{ "ModuleRelativePath", "Classes/Sound/SoundSubmix.h" },
		{ "ToolTip", "Modulation to apply to the submix Dry Level (in dB)" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_USoundSubmix_Statics::NewProp_DryLevelModulation = { "DryLevelModulation", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USoundSubmix, DryLevelModulation), Z_Construct_UScriptStruct_FSoundModulationDestinationSettings, METADATA_PARAMS(Z_Construct_UClass_USoundSubmix_Statics::NewProp_DryLevelModulation_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USoundSubmix_Statics::NewProp_DryLevelModulation_MetaData)) };
#if WITH_METADATA
...
#endif // WITH_EDITORONLY_DATA
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_USoundSubmix_Statics::NewProp_OutputVolumeModulation,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_USoundSubmix_Statics::NewProp_WetLevelModulation,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_USoundSubmix_Statics::NewProp_DryLevelModulation,
	...
	IMPLEMENT_CLASS(USoundSubmix, 161458669);
